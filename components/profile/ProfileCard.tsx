  ...
  return (
    <Card variant="default">
      <CardContent className="p-4">
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5">
              ...
              <PlatformIcon size={14} className="text-muted-foreground shrink-0" />
            </div>
        ...
        {/* Followers */}
        {data.followers && (
          <div className="flex items-center gap-3 text-xs text-muted-foreground pb-3 mb-3 border-b border-border/60">
            <span>
              <span className="text-foreground font-medium">{data.followers}</span> followers
            </span>
          </div>
        )}
          ...
          <div>
            ...
            <div className="space-y-1.5">
              {data.recentPosts.slice(0, 3).map((post, i) => (
                <p key={i} className="text-xs text-muted-foreground/80 line-clamp-2 leading-relaxed">
                  {post}
                </p>
              ))}
            </div>
