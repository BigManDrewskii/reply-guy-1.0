# Reply Guy — Loki Mode Kickstart v4
...
# 2. Create project
mkdir -p ~/reply-guy/docs
cd ~/reply-guy

# 3. Place the PRD
cp /path/to/reply-guy-prd-v4.md ./docs/prd.md

# 4. Create CLAUDE.md (below)

# 5. Launch
claude --dangerously-skip-permissions
```

Paste: `Loki Mode with PRD at docs/prd.md`
...
Launch it. **Phase 1 priority: the extension must install and the side panel must open.** ⚡
