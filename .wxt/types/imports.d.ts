...
declare global {
  ...
  const useApiKey: typeof import('/Users/drewskii/Desktop/Reply Guy Master File /reply-guy-1.0/hooks/useApiKey')['useApiKey']
  const useAppConfig: typeof import('wxt/client')['useAppConfig']
  const useCallback: typeof import('react')['useCallback']
  const useContext: typeof import('react')['useContext']
  const useEffect: typeof import('react')['useEffect']
  const useMemo: typeof import('react')['useMemo']
  const usePageData: typeof import('/Users/drewskii/Desktop/Reply Guy Master File /reply-guy-1.0/hooks/usePageData')['usePageData']
